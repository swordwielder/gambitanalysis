...
soup8 = BeautifulSoup(allTennisSrc, 'lxml')
...
print("----------------------------------------------- College Basketball ----------------------------------", file = sourceFile)
# College Basketball
# -----------------------------------------------------------------------------------------
